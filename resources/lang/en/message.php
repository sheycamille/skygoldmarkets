...
return [
    ...
    'trading_platforms' => [
        ...
        'more_features' => 'Enjoy more features with Sky Gold Markets’ MT5 trading platform. The Sky Gold Markets MT5 is the latest and most advanced MetaTrader platform that offers all the pioneering features of MT4, with the addition of more advanced trading tools and indicators that enable traders to maintain more control of their trades and make more informed decisions using cutting-edge analysis',
    ...
    'order_execution' => [
        ...
        'b14' => 'Still, if the Client wanted to perform an order and given a certain instruction, then by executing that order, Sky Gold Markets will fulfill with Axes Prime ’s responsibility to deliver the best execution for the Client. This may possible result in being unqualified to comply with Sky Gold Markets ’s order execution policy for that certain order.',
    ...
    'body' => [
        ...
        'metatrader5' => 'Download MetaTrader 5 For PC, smartphones, and tablets',
    ...
    'platforms' => 'We provide our clients with a wide range of desktop, web and mobile trading platforms including Sky Gold Markets platform MetaTrader 5 and cTrader.',
