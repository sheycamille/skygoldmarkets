                        ...
                        <div class="uk-grid" data-uk-grid>
                            <div class="uk-width-1-2@m">
                                <div class="uk-overlay">
                                    ...
                                    <p class="uk-text-lead uk-visible@m">Trade Cryptocurrencies, Stock Indices, Commodities
                                        and Forex from a single account</p>
                                    <div class="in-slideshow-button">
                                        <a href="#" class="uk-button uk-button-primary uk-border-rounded">Open
                                            account</a>
                                        <a href="#"
                                            class="uk-button uk-button-default uk-border-rounded uk-margin-small-left uk-visible@m">Discover
                                            account</a>
                                    </div>
                                    <p class="uk-text-small"><span class="uk-text-primary">*</span>Trading in Forex/ CFDs is
                            ...
                            <div class="uk-position-center">
                                <img class="uk-animation-slide-top-small" src="{{ asset('front/img/in-lazy.svg') }}"
                                    data-src="{{ asset('front/img/in-slideshow-image-1.png') }}" alt="slideshow-image" width="862"
                                    height="540" data-uk-img>
                            </div>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="uk-container">
                        <div class="uk-grid" data-uk-grid>
                            ...
                            <div class="uk-position-center">
                                <img class="uk-animation-slide-top-small" src="{{ asset('front/img/in-lazy.svg') }}"
                                    data-src="{{ asset('front/img/in-slideshow-image-2.png') }}" alt="slideshow-image" width="862"
                                    height="540" data-uk-img>
                            </div>
                        </div>
                    </div>
        ...
        <div class="uk-container">
            <div class="uk-grid-divider" data-uk-grid>
                <div class="uk-width-expand@m in-margin-top-20@s">
                    ...
                    <p>With 15+ years of excellence and innovation, we provide high-quality access to financial markets, through our advanced execution model. Discover the world of online trading with CFDs on thousands of instruments in 6 asset classes.</p>
                </div>
                <div class="uk-width-2-3@m">
                    <div class="uk-child-width-1-2@s uk-child-width-1-2@m" data-uk-grid>
                        <div class="uk-flex uk-flex-middle">
                            <div class="uk-margin-right">
                                <img src="{{ asset('front/img/in-lazy.svg') }}" data-src="{{ asset('front/img/in-profit-icon-1.svg') }}" alt="profit-icon"
                        ...
                        <div class="uk-flex uk-flex-middle">
                            <div class="uk-margin-right">
                                <img src="{{ asset('front/img/in-lazy.svg') }}" data-src="{{ asset('front/img/in-profit-icon-2.svg') }}" alt="profit-icon"
                                    width="72" height="72" data-uk-img>
                            </div>
                            <div>
                        ...
                        <div class="uk-flex uk-flex-middle">
                            <div class="uk-margin-right">
                                <img src="{{ asset('front/img/in-lazy.svg') }}" data-src="{{ asset('front/img/in-profit-icon-3.svg') }}" alt="profit-icon"
                                    width="72" height="72" data-uk-img>
                            </div>
                            <div>
                        ...
                        <div class="uk-flex uk-flex-middle">
                            <div class="uk-margin-right">
                                <img src="{{ asset('front/img/in-lazy.svg') }}" data-src="{{ asset('front/img/in-profit-icon-4.svg') }}" alt="profit-icon"
                                    width="72" height="72" data-uk-img>
                            </div>
                            <div>
        ...
        <div class="uk-container">
            <div class="uk-grid uk-flex uk-flex-center">
                <div class="uk-width-1-2@m uk-text-center">
                    ...
                    <p class="uk-text-lead">With 15+ years of excellence and innovation, we provide high-quality access to financial markets, through our advanced execution model. Discover the world of online trading with CFDs on thousands of instruments in 6 asset classes.</p>
                            ...
                            <div class="in-pricing-1">
                                <div class="uk-card uk-card-default uk-box-shadow-medium">
                                    <div class="uk-card-media-top">
                                        <img class="uk-width-1-1 uk-align-center" src="{{ asset('front/img/in-lazy.svg') }}"
                                            data-src="{{ asset('front/img/in-profit-content-1.jpeg') }}" data-width data-height
                                    ...
                                    <div class="uk-card-body">
                                        ...
                                        <p class="uk-margin-small-top">Stay ahead of the markets with world-leading market
                        ...
                        <div>
                            <div class="in-pricing-1">
                                <div class="uk-card uk-card-default uk-box-shadow-medium">
                                    <div class="uk-card-media-top">
                                        <img class="uk-width-1-1 uk-align-center" src="{{ asset('front/img/in-lazy.svg') }}"
                                            data-src="{{ asset('front/img/in-profit-content-2.jpeg') }}" data-width data-height
                                            alt="sample-image" data-uk-img>
                                        <span></span>
                                    </div>
                                    <div class="uk-card-body">
                                        ...
                                        <p class="uk-margin-small-top">Access the financial markets with an account catered
                            ...
                            <div class="uk-card uk-card-default uk-card-body in-profit-appcard">
                                <div class="uk-child-width-1-2@m" data-uk-grid>
                                    <div>
                                        ...
                                        <hr>
                                        <p>Trade on <span class="uk-text-bold uk-text-primary">world class platform</span>
                                            without a doubt.</p>
                                    </div>
                                    <div class="uk-visible@m">
                                        <img src="{{ asset('front/img/in-lazy.svg') }}" data-src="{{ asset('front/img/in-profit-mockup-1.png') }}" width="450"
                                            height="203" alt="profit-mockup" data-uk-img>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="uk-width-1-1">
                            <div class="uk-grid uk-grid-divider uk-grid-match in-profit-tradestatus" data-uk-grid>
                                ...
                                <div class="uk-width-1-1 uk-width-expand@m uk-flex-middle">
                                    <p class="uk-text-lead">Trade & Invest in Stocks, Currencies, Indices, and Commodities
                                        (CFDs).</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="uk-container uk-margin-small-bottom">
            <div class="uk-grid-large" data-uk-grid>
                <div class="uk-width-1-2@m">
                    ...
                    <p class="uk-text-lead">Our clients are provided with exclusive access to trading tools, news and analysis.</p>
                </div>
                <div class="uk-width-1-1">
                ...
                <div class="uk-width-5-6@m">
                    <div class="uk-grid uk-flex-middle" data-uk-grid>
                        ...
                        <div class="uk-width-3-5@m">
                            <p class="uk-text-lead">Access 40,000+ trading instruments and professional asset management on
                ...
                <div class="uk-width-1-1">
                    <div class="uk-child-width-1-2@s uk-child-width-1-5@m in-profit-stockprice" data-uk-grid>
                        <div>
                            <div class="uk-card uk-card-body uk-card-small uk-card-default uk-border-pill">
                                <span class="uk-float-left">
                                    <img src="{{ asset('front/img/in-lazy.svg') }}" data-src="{{ asset('front/img/in-profit-ticker-1.svg') }}" alt="profit-ticker"
                        ...
                        <div>
                            <div class="uk-card uk-card-body uk-card-small uk-card-default uk-border-pill">
                                <span class="uk-float-left">
                                    <img src="{{ asset('front/img/in-lazy.svg') }}" data-src="{{ asset('front/img/in-profit-ticker-2.svg') }}" alt="profit-ticker"
                                        width="77" height="20" data-uk-img>
                                </span>
                                <span class="uk-float-right down">
                        ...
                        <div>
                            <div class="uk-card uk-card-body uk-card-small uk-card-default uk-border-pill">
                                <span class="uk-float-left">
                                    <img src="{{ asset('front/img/in-lazy.svg') }}" data-src="{{ asset('front/img/in-profit-ticker-3.svg') }}" alt="profit-ticker"
                                        width="77" height="20" data-uk-img>
                                </span>
                                <span class="uk-float-right down">
                        ...
                        <div>
                            <div class="uk-card uk-card-body uk-card-small uk-card-default uk-border-pill">
                                <span class="uk-float-left">
                                    <img src="{{ asset('front/img/in-lazy.svg') }}" data-src="{{ asset('front/img/in-profit-ticker-4.svg') }}" alt="profit-ticker"
                                        width="77" height="20" data-uk-img>
                                </span>
                        ...
                        <div class="uk-visible@m">
                            <div class="uk-card uk-card-body uk-card-small uk-card-default uk-border-pill">
                                <span class="uk-float-left">
                                    <img src="{{ asset('front/img/in-lazy.svg') }}" data-src="{{ asset('front/img/in-profit-ticker-5.svg') }}" alt="profit-ticker"
                                        width="77" height="20" data-uk-img>
                                </span>
                                <span class="uk-float-right up">
            ...
            <div class="uk-grid" data-uk-grid>
                <div class="uk-width-1-1">
                    <div class="trustpilot-widget" data-locale="en-GB" data-template-id="5406e65db0d04a09e042d5fc"
                        data-businessunit-id="561d886b0000ff0005844fd6" data-style-height="28px" data-style-width="100%"
                        data-theme="light">
