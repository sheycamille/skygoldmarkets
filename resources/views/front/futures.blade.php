                ...
                <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-5-6@m uk-background-contain uk-background-center-center">
                        <div class="uk-text-center">
                            <h1 class="uk-margin-remove">@lang('message.futures.futures_trading')</h1>
                            <p class="uk-text-lead uk-text-muted uk-margin-small-top">@lang('message.futures.trade_on_futures')</p>
                        </div>
            ...
            <div class="uk-container">
                <div class="uk-grid-large uk-child-width-1-2@m uk-grid" data-uk-grid="">
                    <div class="uk-first-column">
                        ...
                        <h3 class="uk-margin-remove">@lang('message.futures.futures_are')</h3>
