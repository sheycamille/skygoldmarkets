                                ...
                                <form method="POST" action="{{ route('password.email') }}" class="mt-5 card__form">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group" style="display:block">
                                            ...
                                            <input type="email"
                                                ...
                                                placeholder="@lang('message.register.example')" required>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="form-group" style="justify-content:center">
                                        <button class="uk-button uk-button-primary uk-border-rounded"
                                            type="submit">@lang('message.forgot_pass.link')</button>
                                    </div>
                                    <div class="mb-3 text-center">
                                        <small class="mb-2 text-center "> <a
                                                href="{{ route('login') }}">@lang('message.forgot_pass.repeat').</a> </small>
                                    </div>
                                </form>
                            </div>
                        </div>
