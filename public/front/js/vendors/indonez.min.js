window.addEventListener("load", function () {
    ...
    (function () {
        ...
        const e = window.matchMedia("(max-width: 960px)"),
            t =
                (document.querySelectorAll(".uk-navbar-nav li"),
                document.querySelectorAll(".uk-nav-default li"),
                document.querySelectorAll(".uk-navbar-dropdown li")),
            n = document.querySelectorAll(".uk-nav-sub li");
        function a(e) {
...
!(function () {
    ...
    window.addEventListener("scroll", function () {
        setTimeout(function () {
            window.scrollY > 300
                ? ((e.style.opacity = 1),
                  e.classList.add("uk-animation-slide-top"))
                : ((e.style.opacity -= 0.1),
    ...
    (counterUp.prototype.start = function () {
        "use strict";
        var e = this;
        null != document.querySelector(e.props.selector) &&
            new IntersectionObserver(
                function (t) {
            ...
            (t.val += t.step),
                t.val < t.end
                    ? (1 == t.intvalues
                      ...
                      (e = !1))
                    : (t.obj.innerHTML =
                          t.prepend + t.end.toString() + t.append);
        }),
