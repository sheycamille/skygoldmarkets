...
Route::prefix('adminlogin')->group(function () {
    ...
    Route::resource('verify', 'Admin\Auth\TwoFactorController')->only(['index', 'store'])->name('get', 'admin.verify')->name('index', 'admin.verify.index')->name('store', 'admin.verify.check');
});
